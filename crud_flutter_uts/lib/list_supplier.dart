                ...
                itemBuilder: (context, index) {
                    ...
                    child: ListTile(
                        ...
                        children: [
                            ...
                            child: Text("Email Perusahaan: ${kontak.email}"),
                            ), 
                            Padding(
                            padding: const EdgeInsets.only(
                                top: 8,
                            ),
                            child: Text("Nomor Telepon: ${kontak.mobileNo}"),
                            ),
                            Padding(
                            padding: const EdgeInsets.only(
                                top: 8,
                            ),
                            child: Text("Nama Perusahaan: ${kontak.company}"),
                            )
                        ],
                        ),
                        trailing: 
